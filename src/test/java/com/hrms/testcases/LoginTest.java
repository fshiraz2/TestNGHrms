...
public class LoginTest extends CommonMethods {
	...
	public void timeStamp() {
		Date d=new Date();
		System.out.println(d.getTime());//will give numbers no space
		SimpleDateFormat sdf=new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss");//will format the date
		System.out.println(sdf.format(d.getTime())); //only char. available are underscores for files
